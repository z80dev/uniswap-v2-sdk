...
var computePairAddress = function computePairAddress(_ref) {
  ...
  return address.getCreate2Address(factoryAddress, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [token0.address, token1.address])]), initHash);
};
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddressForFactory = function getAddressForFactory(tokenA, tokenB, factoryAddress, initHash) {
    return computePairAddress({
